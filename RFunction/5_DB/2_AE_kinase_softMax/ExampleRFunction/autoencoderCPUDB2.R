...
#' @examples
#' \dontrun{
# autoencoderDB2(group=c("sudo"), scratch.folder="/home/user/scratch", file="/home/user/autoencoderClustering_v4/u/setA.csv",separator=",", permutation=5, nEpochs=1000,projectName="TESTA")
#'}
#' @export
autoencoderDB2 <- function(group=c("sudo","docker"), scratch.folder, file,separator, permutation, nEpochs,patiencePercentage=5,seed=1111,projectName,lr=0.01,loss="mean_squared_error"){
...
system(paste("cp ",data.folder,"/",matrixName,".",format," ",scrat_tmp.folder,"/",sep=""))
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d repbioinfo/autoencoderdb2softkinase python3 /home/autoencoder.py ",matrixNameC,".",format," ",separator," ",permutation," ",nEpochs," ",patiencePercentage," ",projectName," ",seed," ",lr," ",loss,sep="")
